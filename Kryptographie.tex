...
\begin{tabular}{|l|l|l|}
\hline
$G$ & \includegraphics[width=0.2\textwidth,trim=0 0 0 -5]{img/clique1.png} &   Vollständiger Graph mit $C = \{a, b, c  \}$ \\ \hline
$G - ex$ & \includegraphics[width=0.2\textwidth,trim=0 0 0 -5]{img/clique2.png} &   \\ \hline
$G - xy$ & \includegraphics[width=0.2\textwidth,trim=0 0 0 -5]{img/clique3.png} &   \\ \hline
$G - bc$ & \includegraphics[width=0.2\textwidth,trim=0 0 0 -5]{img/clique4.png} &  \\ \hline
\end{tabular}
\end{table}
